...
pub enum MenuItem {
    ...
    Action {
        ...
        /// Whether this menu item is checked in popup menu renderers.
        checked: bool,
...
impl MenuItem {
    ...
    /// Creates a new checked menu item that invokes an action.
    pub fn action_checked(name: impl Into<SharedString>, checked: bool, action: impl Action) -> Self {
        Self::Action {
            name: name.into(),
            action: Box::new(action),
            checked,
