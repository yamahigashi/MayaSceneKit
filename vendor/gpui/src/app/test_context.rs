...
impl TestAppContext {
    ...
    /// Checks whether there have been any path-selection prompts received by the platform.
    ...
    pub fn simulate_path_prompt_selection(
        &self,
        select_paths: impl FnOnce(&crate::PathPromptOptions) -> Option<Vec<std::path::PathBuf>>,
    ) {
        self.test_platform
            .simulate_path_prompt_selection(select_paths);
    }
