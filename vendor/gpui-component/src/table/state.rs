    ...
    D: TableDelegate,
{
    ...
    fn finish_resize_interaction(&mut self, cx: &mut Context<Self>) {
    ...
    fn render_resize_handle(
        ...
        const HANDLE_HITBOX_WIDTH: Pixels = px(16.);
        const HANDLE_VISUAL_WIDTH: Pixels = px(1.);
        ...
        h_flex()
            ...
            .cursor_col_resize()
            .h_full()
            .w(HANDLE_HITBOX_WIDTH)
            .ml(-(HANDLE_HITBOX_WIDTH / 2.))
            .justify_end()
            .items_center()
            .child(
                div()
            ...
            .on_mouse_up_out(
                MouseButton::Left,
                cx.listener(|view, _, _, cx| view.finish_resize_interaction(cx)),
            )
            .into_any_element()
    }
        ...
        div()
            ...
            .when(!loading, |this| {
                this.child(inner_table)
                    .when(self.resizing_col.is_some(), |this| {
                        this.child(
                            div()
                                .absolute()
                                .top(self.options.size.table_row_height())
                                ...
                                .occlude()
                                .cursor_col_resize()
                                .bg(cx.theme().overlay.opacity(0.05))
                                ...
                                .on_mouse_up(
                                    ...
                                    cx.listener(|view, _, _, cx| {
                                        view.finish_resize_interaction(cx);
                                    }),
                                ),
                        )
                    })
